...
archivoDatos = 'datos_con_perturbacion_Modelo_completo_ML_observador_reducido.mat';

% Si queres forzar una nueva simulacion aunque exista el .mat, poner true
forzarSimulacion = false;
...
if exist(archivoDatos, 'file') && ~forzarSimulacion
    ...
    data.T_ld = getSignalData(T_ld_raw);
...
figure('Color', 'w', 'Name', 'Figura 3 - Seguimiento de posicion con perturbación');
...
xlabel('Tiempo [s]', 'FontWeight', 'bold');
ylabel('\theta_m [rad]', 'FontWeight', 'bold');
title('Seguimiento de consigna de posicion nula con Perturbacion', 'FontWeight', 'bold');
...
xlabel('Tiempo [s]', 'FontWeight', 'bold');
ylabel('\theta_m [rad]', 'FontWeight', 'bold');
title('Zoom del seguimiento de posición nula con perturbación', 'FontWeight', 'bold');
legend('\theta_m^*(t)', '\theta_m(t)', 'Location', 'best');
...
title('Error de seguimiento de posición con perturbación', 'FontWeight', 'bold');
...
xlabel('Tiempo [s]', 'FontWeight', 'bold');
ylabel('\omega_m [rad/s]', 'FontWeight', 'bold');
title('Seguimiento de consigna de velocidad con perturbación', 'FontWeight', 'bold');
...
xlabel('Tiempo [s]', 'FontWeight', 'bold');
ylabel('\omega_m [rad/s]', 'FontWeight', 'bold');
title('Zoom del seguimiento de velocidad con perturbación', 'FontWeight', 'bold');
legend('\omega_m^*(t)', '\omega_m(t)', 'Location', 'best');
...
title('Error de seguimiento de velocidad con perturbación', 'FontWeight', 'bold');
...
xlabel('Tiempo [s]', 'FontWeight', 'bold');
ylabel('\theta_m [rad]', 'FontWeight', 'bold');
title('Estimación de posición con perturbación', 'FontWeight', 'bold');
...
xlabel('Tiempo [s]', 'FontWeight', 'bold');
ylabel('\theta_m [rad]', 'FontWeight', 'bold');
title('Zoom de la estimación de posición con perturbación', 'FontWeight', 'bold');
legend('$\theta_m(t)$', '$\hat{\theta}_m(t)$',...
       'Location', 'best', 'Interpreter', 'latex');
...
title('Error de estimación de posición con perturbación', 'FontWeight', 'bold');
...
xlabel('Tiempo [s]', 'FontWeight', 'bold');
ylabel('\omega_m [rad/s]', 'FontWeight', 'bold');
title('Estimación de velocidad', 'FontWeight', 'bold');
...
xlabel('Tiempo [s]', 'FontWeight', 'bold');
ylabel('\omega_m [rad/s]', 'FontWeight', 'bold');
title('Zoom de la estimación de velocidad con perturbación', 'FontWeight', 'bold');
...
%% Figura 11: T_ld
figure('Color', 'w', 'Name', 'Figura 11 - Torque de Perturbacion');

plot(data.T_ld.t, data.T_ld.y, ...
    'LineWidth', 1.5, 'Color', color_consigna);
grid on; box on;
xlabel('Tiempo [s]', 'FontWeight', 'bold');
ylabel('T_{ld} [Nm]', 'FontWeight', 'bold');
title('Torque de Perturbacion T_{ld}(t)', 'FontWeight', 'bold');
legend('T_{ld}(t)', 'Location', 'best');
